...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("Johncena@academy.com");
		driver.findElement(By.xpath("//input[@type='text'][2]")).clear();
		driver.findElement(By.cssSelector("input[type='text']:nth-child(3)")).sendKeys("john@academy.com");
		driver.findElement(By.xpath("//form/input[3]")).sendKeys("97756781908");
